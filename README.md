...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/yaqd-gage-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11640&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/yaqd-gage-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `yaqd-gage` can be installed with:

```
conda install yaqd-gage
```

It is possible to list all of the versions of `yaqd-gage` available on your platform with:
